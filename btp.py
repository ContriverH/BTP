...
def pre_steps():
    # try:
    # getting the coordinates from the preprocess method of the lane.py
    # image_path = "road_lane.png"
    # image1 = cv2.imread(image_path)
    coordinates = preprocess('Highway.mp4')
    # print(coordinates)
    try:
        for cor in coordinates:
            ret, frame = cap.read()
            starting_x = cor[0][0]
            starting_y = cor[0][1] - 20
            ending_x = cor[1][0]
            ending_y = cor[1][1]
            # print(cor)
